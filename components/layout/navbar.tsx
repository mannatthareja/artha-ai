          ...
          <DropdownMenuContent align="end" className="w-80">
            ...
            <DropdownMenuItem className="flex flex-col items-start gap-1 p-3">
              ...
              <span className="text-xs text-muted-foreground">
                Your GSTR-3B is due in 3 days
              </span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 p-3">
              <span className="font-medium">Tax Saving Tip</span>
              <span className="text-xs text-muted-foreground">
                You can save up to ₹12,000 by switching to new regime
              </span>
            </DropdownMenuItem>
            <DropdownMenuItem className="flex flex-col items-start gap-1 p-3">
              <span className="font-medium">Document Processed</span>
              <span className="text-xs text-muted-foreground">
                Your salary slip has been analyzed
              </span>
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
